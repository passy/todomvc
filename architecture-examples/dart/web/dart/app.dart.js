...
$$.TodoWidget = {"":"Object;todoApp>,todo>,element>,toggleElement",
 createElement$0: function() {
  ...
  $.getInterceptor$JSArray(t3).add$1(t3, new $.TodoWidget_createElement_anon0(this, editElement));
  t3 = new $.TodoWidget_createElement_removeTodo(this);
  t4 = this.element.query$1(".destroy").get$on().get$click();
  $.getInterceptor$JSArray(t4).add$1(t4, new $.TodoWidget_createElement_anon1(this, t3));
  t3 = new $.TodoWidget_createElement_doneEditing(this, contentElement, t3, editElement);
...
$$.TodoApp = {"":"Object;todoWidgets=,todoListElement,mainElement,checkAllCheckboxElement>,footerElement,countElement,clearCompletedElement,showAllElement,showActiveElement,showCompletedElement",
 ...
 initElementEventListeners$0: function() {
  ...
  $.getInterceptor$JSArray(t1).add$1(t1, new $.TodoApp_initElementEventListeners_anon(this, newTodoElement));
...
$$.TodoWidget_createElement_doneEditing = {"":"Closure;this_6,contentElement_7,removeTodo_8,editElement_9",
 call$1: function(event$) {
  var t1, t2;
  t1 = this.editElement_9.get$value();
